...
last2 :: Int -> Int
last2 0 = 0
last2 x = let last2' = x `mod` 100 in last2'

sumLast2 :: Int -> Int
sumLast2 0 = 0
sumLast2 last2' = (last2' `mod` 10) + sumLast2 (last2' `div` 10)
-}
sumd :: Int -> Int
sumd 0 = 0
...
sumLast2 :: Int -> Int
sumLast2 0 = 0
sumLast2 x = let last2' = last2 x in (last2' `mod` 10) + sumLast2 (last2' `div` 10)
...
firstDigit :: Int -> Int
firstDigit n
  | (length . show $ n) >= 2 = read . take 1 . show $ n
